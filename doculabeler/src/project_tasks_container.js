...
export const ProjectTasksContainer = (params) => {
    ...
    const handleTaskCreationConfirm = async () => {
        ...
        const task_creation_res = await fetch('http://192.168.230.235:8080/task/create_task', {
          method: 'POST',
          //headers: {
    ...
    async function deleteTask(task_id) {
      ...
      await fetch('http://192.168.230.235:8080/task/delete_task', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
    ...
    async function getProjectTasks(project_id) {
        ...
        const formData = new URLSearchParams();
        formData.append('project_id', project_id);
        await fetch('http://192.168.230.235:8080/task/get_project_tasks', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8',
          },
    ...
    const handleStopModifyDescription = async () => {
      ...
      const response = await fetch("http://192.168.230.235:8080/project/update_project_description", {
          method: "POST",
          headers: {
